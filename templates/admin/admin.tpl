	...
	<header role="banner" class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://kliqqi.com/"><img src="{$my_base_url}{$my_kliqqi_base}/templates/admin/img/kliqqi.png" class="adm_logo" /></a>
			</div>
						...
						<div id="AdminAccordion" class="accordion">
							...
							<div class="accordion-group">
								<div class="btn btn-default col-md-12 accordion-heading">
									...
									<span class="badge accordion-heading-alert">
										<a href="{$my_base_url}{$my_kliqqi_base}/admin/admin_widgets.php">1</a>
									</span>
								</div>
								<div class="accordion-body " id="CollapseWidgets">
									<ul class="accordion-inner">
										<li {if $pagename eq "admin_widgets"}{php} if ($_GET["status"] == ""){ echo 'class="active"'; } {/php}{/if} id="widgets_installed"><a href="{$my_base_url}{$my_kliqqi_base}/admin/admin_widgets.php">Installed {#KLIQQI_Visual_AdminPanel_Widgets_Nav#} <span class="pull-right badge badge-gray">1</span></a></li> 
