<?
	...
	$bigtree["config"]["domain"] = "http://phobia.robjustice.net";	// "domain" should be http://www.website.com
	$bigtree["config"]["www_root"] = "http://phobia.robjustice.net/site/index.php/"; // "www_root" should be http://www.website.com/location/of/the/site/
	$bigtree["config"]["static_root"] = "http://phobia.robjustice.net/site/"; // "static_root" can either be the same as "www_root" or another domain that points to the same place -i t is used to server static files to increase page load time due to max connections per domain in most browsers.
	$bigtree["config"]["admin_root"] = "http://phobia.robjustice.net/site/index.php/admin/"; // "admin_root" should be the location you want to access BigTree's admin from, i.e. http://www.website.com/admin/
	...
	$bigtree["config"]["db"]["host"] = "mysql.robjustice.net";
	$bigtree["config"]["db"]["name"] = "phobia";
	$bigtree["config"]["db"]["user"] = "phobia_rjnet";
	$bigtree["config"]["db"]["password"] = "Q3F8RKWr";
