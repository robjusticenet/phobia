...
// intro / step 1
	$lang['WelcomeToInstaller'] = 'مرحبا بك في مثبت kliqqi!';
	$lang['Introduction'] = 'مقدمة';
	$lang['WelcomeToThe'] = 'مرحبا بكم مع <a href="http://www.kliqqi.com" target="_blank">Kliqqi Content Management System</a>. قبل التثبيت الرجاء التأكد من حصولك على أحدث اصداراتنا من <a href="http://www.kliqqi.com/download.php" target="_blank">the official Kliqqi Download Page</a>.';
	$lang['Bugs'] = 'عند زيارتك لموقع Kliqqi.com, رجاء قم بقراءة الوثائق المقدمة من مجموعتنا. كما نقترح عليك التسجيل معنا للحصول على الكثير من المصادر من خلال هذا الرابط<a href="http://forums.kliqqi.com/" target="_blank">Kliqqi Forum</a>. في حال وجدت أية مشاكل في النسخة التي تستخدمها الرجاء ابلاغنا عنها من خلال هذا الرابط <a href="http://forums.kliqqi.com/projects/kliqqi-cms/index.html" target="_blank">report it</a>.';
	$lang['Installation'] = 'التثبيت - اقرأها جيدا';
	$lang['OnceFamiliar'] = '<p>إذا كانت هذه مرتك الأولى التي تثبت فيها Kliqqi عليك متابعة التعليمات من خلال هذه الصفحة. اذا كنت تريد <a href="./upgrade.php">ترقية موقعك</a> من نسخة أقدم فقم بالنقر على ترقية. تحذير: قيامك بعملية التثبيت على موقع موجود مسبقا سيقوم بالكتابة على اليانات الموجودة.</p><br />
	<ol>
	...
	أنت الآن في الماضي الجزء الأصعب! المضي قدما إلى الخطوة التالية لتثبيت Kliqqi على قاعدة بيانات MySQL الخاص بك.';
