...
// Upgrade
	$lang['UpgradeHome'] = '<p>的Kliqqi通过点击下面的按钮，将数据库升级到最新版本。它还将增加新的短语的最新产品附加语言文件的底部。您仍然需要上传新文件，并手动更新模板完全与兼容的最新版本。</p><p>我们建议您备份您的网站和数据库到本地计算机，然后再继续，因为升级过程将进行永久性更改你的MySQL数据库。</p>';
