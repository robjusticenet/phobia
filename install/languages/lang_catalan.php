...
// Upgrade
	$lang['UpgradeHome'] = 'En fer clic al botó de sota, Kliqqi actualitzarà la seva base de dades a l\'última versió. També afegirà noves frases afegint les darreres incorporacions a la part inferior del seu arxiu d\'idioma. Vostè encara haurà de carregar els nous arxius i actualitzar manualment les plantilles per ser totalment compatible amb l\'última versió.</p> Li recomanem que faci una còpia del seu lloc web i la base de dades en l\'equip local abans de continuar, perquè el procés d\'actualització farà canvis permanents a la base de dades MySQL.';
