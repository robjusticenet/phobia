...
// intro / step 1
	$lang['WelcomeToInstaller'] = 'Bienvenue à l\'installateur CMS Kliqqi!';
	$lang['Introduction'] = 'présentation';
	$lang['WelcomeToThe'] = 'Bienvenue à <a href="http://kliqqi.com" target="_blank">Kliqqi Content Management System</a>, le CMS qui alimente des milliers de sites communautaires. Si c\'est votre première fois d'installer Kliqqi, s\'il vous plaît lire toutes les instructions fournies avec soin afin que vous n \'t manquez aucune des orientations importantes. Au nom des développeurs Kliqqi, je tiens à vous et votre nouveau site souhaiter la meilleure des chances.';
	$lang['Bugs'] = 'S\'il vous plaît de vous familiariser avec quelques-uns de la documentation fournie par la communauté Kliqqi à l\' <a href="http://kliqqi.com/support/">Kliqqi Support</a> site. Nous vous suggérons également de créer un compte afin que vous aurez accès à une assistance gratuite, des modules, des widgets, des modèles et d\'autres grandes ressources. Si vous constatez des bugs ou si vous voulez juste de proposer une nouvelle fonctionnalité, s\'il vous plaît envoyer vos commentaires sur notre propre très <a href="http://kliqqi.com/demo/">Kliqqi Demo website</a>.';
	...
	Vous êtes maintenant passé le plus dur! Passez à l\'étape suivante pour installer Kliqqi sur votre base de données MySQL.</p>';
...
// step 2
	...
	$lang['PrefixExample'] = '(ie: "kliqqi_" rend les tables pour les utilisateurs deviennent kliqqi_users)';
