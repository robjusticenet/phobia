...
echo 'Creating table: \'widgets\'....<br />';
	...
	echo '<li>Setting Kliqqi Version</li>';
	$sql = "INSERT INTO `" . table_misc_data . "` ( `name` , `data` ) VALUES ('kliqqi_version', '3.0.0');";
	mysql_query( $sql, $conn );

	echo '<li>Setting Captcha Method to SolveMedia</li>';
	$sql = "UPDATE `" . table_misc_data . "` SET `data` = 'solvemedia' WHERE `kliqqi_misc_data`.`name` = 'captcha_method';";
	mysql_query($sql,$conn);
	...
	mysql_query($sql,$conn);
	$sql = "INSERT INTO `" . table_misc_data . "` ( `name` , `data` ) VALUES ('adcopy_pubkey', '1G9ho6tcbpytfUxJ0SlrSNt0MjjOB0l2');";
	mysql_query($sql,$conn);
	$sql = "INSERT INTO `" . table_misc_data . "` ( `name` , `data` ) VALUES ('adcopy_privkey', 'PjH8h3gpjQrBKihJ8dlLN8sbcmvW1nv-');";
	mysql_query($sql,$conn);
	$sql = "INSERT INTO `" . table_misc_data . "` ( `name` , `data` ) VALUES ('adcopy_hashkey', 'eq1xxSfyG55k4ll7CxPCO6XP9-cIWnTf');";
	mysql_query($sql,$conn);
...
echo '<li>Inserting default "All" and "News" categories</li>';
	...
	$sql = "INSERT INTO `" . table_modules . "` (`name`, `version`, `latest_version`, `folder`, `enabled`, `weight`) VALUES ('Admin Modify Language', 2.1, 0, 'admin_language', 1,0);";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `" . table_modules . "` (`name`, `version`, `latest_version`, `folder`, `enabled`, `weight`) VALUES ('Captcha', 2.4, 0, 'captcha', 1,0);";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `" . table_modules . "` (`name`, `version`, `latest_version`, `folder`, `enabled`, `weight`) VALUES ('Simple Private Messaging', 2.3, 0, 'simple_messaging', 1,0);";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `" . table_modules . "` (`name`, `version`, `latest_version`, `folder`, `enabled`, `weight`) VALUES ('Sidebar Stories', 2.0, 0, 'sidebar_stories', 1,0);";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `" . table_modules . "` (`name`, `version`, `latest_version`, `folder`, `enabled`, `weight`) VALUES ('Sidebar Comments', 2.0, 0, 'sidebar_comments', 1,0);";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `" . table_modules . "` (`name`, `version`, `latest_version`, `folder`, `enabled`, `weight`) VALUES ('Karma module', 0.2, 0, 'karma', 1,0);";
	mysql_query( $sql, $conn );
	...
	$sql = "INSERT INTO `".table_widgets."` VALUES (NULL, 'Dashboard Tools', 0.1, 0, 'dashboard_tools', 1, 'left', 4, '')";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `".table_widgets."` VALUES (NULL, 'Statistics', 0.2, 0, 'statistics', 1, 'left', 1, '')";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `".table_widgets."` VALUES (NULL, 'Kliqqi CMS', 1.0, 0, 'kliqqi_cms', 1, 'right', 5, '')";
	mysql_query( $sql, $conn );
	$sql = "INSERT INTO `".table_widgets."` VALUES (NULL, 'Kliqqi News', 0.1, 0, 'kliqqi_news', 1, 'right', 6, '')";
	mysql_query( $sql, $conn );
...
//	print "<li>Converting tables to UTF-8</li>";
	$stmts = "ALTER TABLE  `kliqqi_categories` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_comments` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_config` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_formulas` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_friends` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_group_member` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_group_shared` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_groups` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_links` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_messages` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_misc_data` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_modules` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_redirects` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_saved_links` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_tag_cache` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_tags` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_totals` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_trackbacks` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_users` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
		ALTER TABLE  `kliqqi_votes` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_categories`
		...
		ALTER TABLE  `kliqqi_comments` CHANGE  `comment_content`  `comment_content` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_config` CHANGE  `var_page`  `var_page` VARCHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
		...
		ALTER TABLE  `kliqqi_formulas` CHANGE  `type`  `type` VARCHAR( 10 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
		...
		ALTER TABLE  `kliqqi_links` CHANGE  `link_url`  `link_url` VARCHAR( 200 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
		...
		ALTER TABLE  `kliqqi_messages` CHANGE  `title`  `title` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
		CHANGE  `body`  `body` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_misc_data` CHANGE  `name`  `name` VARCHAR( 20 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
		CHANGE  `data`  `data` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_modules` CHANGE  `name`  `name` VARCHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
		CHANGE  `folder`  `folder` VARCHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_redirects` CHANGE  `redirect_old`  `redirect_old` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
		CHANGE  `redirect_new`  `redirect_new` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_tag_cache` CHANGE  `tag_words`  `tag_words` VARCHAR( 64 ) CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_tags` CHANGE  `tag_lang`  `tag_lang` VARCHAR( 4 ) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT  'en',
		CHANGE  `tag_words`  `tag_words` VARCHAR( 64 ) CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_totals` CHANGE  `name`  `name` VARCHAR( 10 ) CHARACTER SET utf8 COLLATE utf8_general_ci;

		ALTER TABLE  `kliqqi_trackbacks` CHANGE  `trackback_type`  `trackback_type` ENUM(  'in',  'out' ) DEFAULT  'in',
		...
		ALTER TABLE  `kliqqi_users` CHANGE  `user_login`  `user_login` VARCHAR( 32 ) CHARACTER SET utf8 COLLATE utf8_general_ci,
	...
	foreach($stmts as $stmt) {
	  $stmt = str_replace("`kliqqi_", "`".table_prefix, $stmt);
  	  mysql_query($stmt);
	}
	...
	mysql_query("INSERT INTO `" . table_config . "` ( `var_id` , `var_page` , `var_name` , `var_value` , `var_defaultvalue` , `var_optiontext` , `var_title` , `var_desc` , `var_method` , `var_enclosein` )VALUES (NULL, 'Misc', 'user_language', '0', '0', '1 = yes / 0 = no', 'Select Language', 'Allow users to change Kliqqi language', 'normal', '\'');");
