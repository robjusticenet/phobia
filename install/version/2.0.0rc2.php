<?php
// This file is for performing an upgrade from Kliqqi 2.0.0rc1 to 2.0.0rc2
...
// Check if you need to run the one time upgrade to Kliqqi 2.0.0rc2
if ($kliqqi_version == '2.0.0rc1') {

	echo '<li>Performing one-time Kliqqi 2.0.0 RC2 Upgrade<ul>';
	...
	$sql = "UPDATE `" . table_misc_data . "` SET `data` = '2.0.0rc2' WHERE `name` = 'kliqqi_version';";
	$db->query($sql);
