<?php
// This file is for performing an upgrade from Kliqqi 1.2.2 to 2.0.0rc1
...
// Check if you need to run the one time upgrade to Kliqqi 2.0.0rc1
if ($kliqqi_version == '1.2.2') {

	echo '<li>Performing one-time Kliqqi 2.0.0rc1 Upgrade<ul>';
	...
	$sql = "UPDATE `" . table_misc_data . "` 
			SET `data` = 'solvemedia' 
			WHERE `kliqqi_misc_data`.`name` = 'captcha_method';";
	$db->query($sql);
...
<ol>
	<li><a rel=\"nofollow\" href=\"#what_is\">What is {#KLIQQI_Visual_Name#}?</a></li>
	<li><a rel=\"nofollow\" href=\"#different\">How is {#KLIQQI_Visual_Name#} different?</a></li>
...
<h2>Answers</h2>
<hr />
<p><a name=\"what_is\"><strong>1. What is {#KLIQQI_Visual_Name#}? </strong></a></p>
<p>At {#KLIQQI_Visual_Name#} you can discover, share and submit great articles, news and videos gathered from all around the web. We are a mix of social network and news agency. Users like yourself can contribute content, as well as help choose what submissions make it to the front page through our voting mechanism.</p>
<hr />
<p><a name=\"different\"><strong>2. How is {#KLIQQI_Visual_Name#} different? </strong></a></p>
<p>The most important component of {#KLIQQI_Visual_Name#} is you, the reader. Everything within the site is crowd-sourced by our visitors. Anyone has the authority to control the content through voting submissions or comments up and down, making readers like you the moderators of this site.</p>
<hr />
<p><a name=\"private_messages\"><strong>3. Private Messaging</strong></a></p>
<p>A social network site isn''t very social without the ability to communicate with other members. {#KLIQQI_Visual_Name#} includes a private messaging feature so that you can send a direct message to your friends that they can respond to.</p>
...
<p>Each user that signs up to {#KLIQQI_Visual_Name#} gets their own profile page where they can change their settings, send messages to other users, add an avatar, and view their voting and comment history.</p>
...
<p>Are you a content producer who wants more traffic? Share your articles, news & videos on {#KLIQQI_Visual_Name#} and get better exposure in the form of backlinks, comments, subscriptions and repeat visitors to your website.</p>
<p>Readers, {#KLIQQI_Visual_Name#} offers an easy way to discover new content which is generated and filtered by our online community. <a href=\"{$URL_register}\">Join</a> to become part of that community and help determine the direction of this website.</p>
<hr />
...
<a href=\"#top\"><i class=\"fa fa-arrow-up\" style=\"opacity:1.0;\"></i> Top</a><br /><br />', '', '', 'Frequently Asked Questions,FAQ,Help', 'Frequently Asked Questions', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0);";
	...
	$sql = "UPDATE `" . table_misc_data . "` SET `data` = '2.0.0rc1' WHERE `name` = 'kliqqi_version';";
	$db->query($sql);
