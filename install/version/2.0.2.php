<?php
// This file is for performing an upgrade from Kliqqi 2.0.1 to 2.0.2
...
if (version_compare($kliqqi_version, '2.0.1') <= 0) {

	echo '<li>Performing one-time Kliqqi 2.0.2 Upgrade<ul>';

	// Update version number
	$sql = "UPDATE `" . table_misc_data . "` SET `data` = '2.0.2' WHERE `name` = 'kliqqi_version';";
	$db->query($sql);
