<?php
// This file is for performing an upgrade from Kliqqi 2.0.0rc3 to 2.0.1
...
if (version_compare($kliqqi_version, '2.0.0') <= 0) {

	echo '<li>Performing one-time Kliqqi 2.0.1 Upgrade<ul>';
	...
	$sql = "UPDATE `" . table_misc_data . "` SET `data` = '2.0.1' WHERE `name` = 'kliqqi_version';";
	$db->query($sql);
