<?php
// This file is for performing an upgrade from Kliqqi 2.0.0rc2 to 2.0.0
...
// Check if you need to run the one time upgrade to Kliqqi 2.0.0
if ($kliqqi_version == '2.0.0rc2') {

	echo '<li>Performing one-time Kliqqi 2.0.0 Upgrade<ul>';
	...
	$sql = "UPDATE `" . table_misc_data . "` SET `data` = '2.0.0' WHERE `name` = 'kliqqi_version';";
	$db->query($sql);
