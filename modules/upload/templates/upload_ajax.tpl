			...
			<tr class="upload_ajax_image">
				<td>
					...
					{elseif $image.file_size=='orig'}
						<a href="{$my_kliqqi_base}{$upload_directory}/{$image.file_name}" target="_blank"><img  src='{$my_kliqqi_base}{$upload_directory}/{$image.file_name}' height="{$image_height}" width="{$image_width}" class="upload_ajax_image_preview" /></a>
					{else}
						<img src='{$my_kliqqi_base}{$upload_thdirectory}/{$image.file_name}' height="{$image_height}" width="{$image_width}" class="upload_ajax_image_preview"/>
					{/if}
				</td>
			</tr>
			{*
